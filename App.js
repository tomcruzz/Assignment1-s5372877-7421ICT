...
//         </TouchableOpacity>
//         <TouchableOpacity
//           style={[styles.button, { backgroundColor: '#008ae6' }]}
...
//         <Ionicons name={todo.completed ? 'checkmark-circle' : 'ellipse-outline'} size={24} color={todo.completed ? 'green' : 'black'} />
//       </TouchableOpacity>
...
//         />
//       </TouchableOpacity>
//       <Text style={[styles.todoItemText, { textDecorationLine: todo.completed ? 'line-through' : 'none' }]}>
//         {todo.text}
//       </Text>
//       <TouchableOpacity onPress={() => setShowDescription(!showDescription)}>
//         <Ionicons name={showDescription ? 'caret-up' : 'caret-down'} size={24} color="black" />
//       </TouchableOpacity>
//       {showDescription && <Text>{todo.description}</Text>}
//       <TouchableOpacity onPress={onDelete}>
//         <Ionicons name="trash-bin" size={24} color="red" />
//       </TouchableOpacity>
//     </View>
